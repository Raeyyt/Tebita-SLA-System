...
app.include_router(role_dashboard.router, prefix="/api")
...
app.include_router(visual_analytics.router, prefix="/api")
app.include_router(settings_router_module.router, prefix="/api")
